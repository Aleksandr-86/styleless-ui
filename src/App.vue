...
import { ref } from 'vue'
import TestComponent from './components/field/TestComponent.vue'
  ...
  <div class="flex flex-col gap-y-4">
    ...
    <div class="flex flex-col gap-y-4 bg-slate-300 p-5">
      ...
      <div class="flex gap-3">
        <TestComponent v-for="key in 3" :key="key" v-model="testModel" class="w-1/3" />
      </div>
    </div>
    ...
    <div class="flex flex-col gap-y-4 bg-slate-300 p-5">
      ...
      <div class="flex flex-wrap gap-3">
        <TestComponent v-for="key in 9" :key="key" v-model="testModel" class="w-[300px]" />
      </div>
    </div>
  </div>
</template>
